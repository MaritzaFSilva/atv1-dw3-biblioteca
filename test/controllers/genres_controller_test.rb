...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { category_id: @genre.category_id, description: @genre.description, name: @genre.name } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { category_id: @genre.category_id, description: @genre.description, name: @genre.name } }
